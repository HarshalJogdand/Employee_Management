		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsplemployeetaskmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplemployeetaskmanagement-display": {
								"semanticObject": "comibsplemployeetaskmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.employeetaskmanagement",
									"url": sap.ui.require.toUrl("com/ibspl/employeetaskmanagement")
								}
							}
						}
					}
